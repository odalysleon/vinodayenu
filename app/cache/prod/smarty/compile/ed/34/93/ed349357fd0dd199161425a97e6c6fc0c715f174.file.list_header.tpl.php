<?php /* Smarty version Smarty-3.1.19, created on 2019-04-11 11:34:37
         compiled from "/srv/www/vinodayenu.com/www/admin898yvnpu5/themes/default/template/controllers/customer_threads/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6265616045caf0a2d373110-33089025%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed349357fd0dd199161425a97e6c6fc0c715f174' => 
    array (
      0 => '/srv/www/vinodayenu.com/www/admin898yvnpu5/themes/default/template/controllers/customer_threads/helpers/list/list_header.tpl',
      1 => 1554200788,
      2 => 'file',
    ),
    '955013310f00b793d6061fd14aa579021c2412a1' => 
    array (
      0 => '/srv/www/vinodayenu.com/www/admin898yvnpu5/themes/default/template/helpers/list/list_header.tpl',
      1 => 1554200609,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6265616045caf0a2d373110-33089025',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5caf0a2d692770_48573335',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5caf0a2d692770_48573335')) {function content_5caf0a2d692770_48573335($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/srv/www/vinodayenu.com/www/vendor/prestashop/smarty/plugins/function.math.php';
?>
			...
			<div class="col-lg-3">
				<div class="panel">
					...
					<?php if ($_smarty_tpl->tpl_vars['total_thread']->value==0) {?>
						<span class="message-mail"><?php echo smartyTranslate(array('s'=>'No new messages','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span>
					<?php } else { ?>
						<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['currentIndex']->value,'html','UTF-8');?>
...
&amp;viewcustomer_thread" class="button">
							...
							<?php if ($_smarty_tpl->tpl_vars['total_thread']->value>1) {?><?php echo smartyTranslate(array('s'=>'New messages','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'New message','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
<?php }?>
						</a>
					<?php }?>
				</div>
		...
		<div class="col-lg-3">
			<div id="MeaningStatus" class="panel">
				<div class="panel-heading">
					<?php echo smartyTranslate(array('s'=>'Meaning of status','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>

				</div>
				<ul class="list-unstyled">
					<li class="text-success"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Open','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</li>
					<li class="text-danger"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Closed','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</li>
					<li class="text-warning"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Pending 1','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</li>
					<li class="text-warning"><i class="icon-circle"></i> <?php echo smartyTranslate(array('s'=>'Pending 2','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</li>
				</ul>
			</div>
		</div>
		<div class="col-lg-3">
			<div id="CustomerService" class="panel">
				<div class="panel-heading">
					<?php echo smartyTranslate(array('s'=>'Statistics','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
