<?php /* Smarty version Smarty-3.1.19, created on 2019-04-13 07:33:47
         compiled from "module:ps_shoppingcart/modal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6246234785cb174bb2c7420-26005944%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '6246234785cb174bb2c7420-26005944',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cb174bb3a3a06_50786249',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cb174bb3a3a06_50786249')) {function content_5cb174bb3a3a06_50786249($_smarty_tpl) {?>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><i class="material-icons">&#xE876;</i><?php echo smartyTranslate(array('s'=>'Product successfully added to your shopping cart','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
          ...
          <?php } else { ?>
            <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><i class="material-icons">&#xE876;</i><?php echo smartyTranslate(array('s'=>'Product can not be add to your shopping cart','d'=>'Shop.Theme.Checkout'),$_smarty_tpl);?>
</h4>
          <?php }?>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="alert-warning p-2 text-center">
              <p>No puede agregar productos de distintas categorias en la misma compra.</p>
            </div>
          </div>
