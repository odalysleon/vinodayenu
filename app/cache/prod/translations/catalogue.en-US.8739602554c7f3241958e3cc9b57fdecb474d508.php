...
EXPECTED DATE OF DELIVERY:[break]
- For purchases in Spain: from 3 to 6 working days from when the order is processed.[break]
- For purchases in Europe: from 5 to 10 working days from when the order is collected depending on the destination.[break]
[break]
PLEASE TAKE NOTE that our products come from different warehouses and therefore we will do partial deliveries of your purchase grouped by categories:[break]
- The products of our WINE category come from our warehouse in Cómpeta, Málaga.[break]
- The products of our category HAMS AND SAUSAGES come from our warehouse in Guijuelo Salamanca.[break]
- The products of our category OILS leave from our warehouse in Priego de Córdoba, Córdoba.',
    ...
    'El peso del pedido no puede exceder los 90kg.' => 'The weight of the order can not exceed 90kg.',
    'Le recomendamos que realice varios pedidos con un peso menor a 90 kg para obtener los productos que desea.' => 'We recommend you to perform multiple orders weighing less than 90 kg for the products you want.',
  ...
  array (
    ...
    'Price' => 'Price',
    'Unit' => 'Unit',
    'REQUEST A BUDGET' => 'REQUEST A BUDGET',
    ...
    '(Add to the cart to request a budget)' => '(Add to the cart to request a budget)',
