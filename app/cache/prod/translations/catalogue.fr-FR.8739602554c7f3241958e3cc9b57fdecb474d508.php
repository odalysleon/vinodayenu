...
<br />- Donner les droits d\'écriture du fichier créé (CHMOD 666 sur les systèmes Unix).',
  ...
  array (
    ...
    'Name' => 'Nom',
    'Address' => 'Adresse',
    'CP Municipality' => 'Municipalité CP',
    'State Country' => 'État Pays',
    'Phone' => 'Téléphone',
...
Cordialement,',
  ...
  array (
    ...
    'Price' => 'Prix',
    'REQUEST A BUDGET' => 'DEMANDE DE BUDGET',
    'ASK FOR PRICE' => 'ASK FOR PRICE',
    'Unit' => 'Unite',
    'See Description' => '(* Voir la Description)',
    'Save %percentage%' => 'Économisez %percentage%',
    'Save %amount%' => 'Économisez %amount%',
    '(Add to the cart to request a budget)' => '(Ajouter au panier pour demande de budget)',
...
DATE DE LIVRAISON ATTENDUE:[break]
- Pour les achats en Espagne: 3 à 6 jours ouvrables depuis le paiement de la commande est traitée.[break]
- Pour les achats en Europe: 5 à 10 jours ouvrables depuis l\'ordre de paiement est traitée en fonction de la destination.[break]
[break]
VEUILLEZ NOTER que nos produits proviennent d’entrepôts différents. Nous effectuerons donc des livraisons partielles de vos achats groupées par catégories:[break]
- Les produits de notre catégorie VIN proviennent de notre entrepôt situé à Cómpeta, Málaga.[break]
- Les produits de notre catégorie JAMBONS ET SAUCISSES proviennent de notre entrepôt situé à Guijuelo Salamanca.[break]
- Les produits de notre catégorie HUILES partent de notre entrepôt à Priego de Córdoba, Córdoba.',
    ...
    'El peso del pedido no puede exceder los 90kg.' => 'Le poids de la commande ne peut dépasser 90 kg.',
    'Le recomendamos que realice varios pedidos con un peso menor a 90 kg para obtener los productos que desea.' => 'Nous vous recommandons de passer plusieurs commandes pesant moins de 90 kg pour obtenir les produits que vous souhaitez.',
