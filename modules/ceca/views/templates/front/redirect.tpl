 ...
 *}
{capture name=path}<a href="{$link->getPageLink('order.php', true)|escape:'html':'UTF-8'}">{l s='Your shopping cart' mod='ceca'}</a><span class="navigation-pipe">{$navigationPipe|escape:'htmlall':'UTF-8'}</span>{l s='Credit card payment' mod='ceca'}{/capture}
<p>&nbsp;</p>
<br/>
<div class="pasatDiv">
