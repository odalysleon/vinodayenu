            ...
            foreach ($package_list as $id_address => $packageByAddress) {
                foreach ($packageByAddress as $id_package => $package) {
                    ...
                    if(isset($_GET['envialia'])){
                        $order->total_shipping_tax_excl += (float)$_GET['envialia_charge'];
                        $order->total_shipping_tax_incl += (float)$_GET['envialia_charge'];
                    }
                    ...
                    if(isset($_GET['envialia'])){
                        $order->total_paid_tax_excl += (float)$_GET['envialia_charge'];
                        $order->total_paid += (float)$_GET['envialia_charge'];
