...
{block name='step_content'}
    ...
    {if $is_free}
        <p>{l s='We will put in contact with you as soon as posible to agree about shipping and payment' d='Shop.Theme.Checkout'}</p>
    {/if}
    ...
    <div id="payment-confirmation">
        <div class="ps-shown-by-js">
            {if $is_free && $action}
                <a href="{$action}" class="btn btn-primary center-block">
                    {l s='Payment estimate request' d='Shop.Theme.Checkout'}
                </a>
            {else}
