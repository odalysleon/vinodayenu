    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><i class="material-icons">&#xE876;</i>{l s='Product successfully added to your shopping cart' d='Shop.Theme.Checkout'}</h4>
          {else}
            <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><i class="material-icons">&#xE876;</i>{l s='Product can not be add to your shopping cart' d='Shop.Theme.Checkout'}</h4>
          {/if}
      </div>
